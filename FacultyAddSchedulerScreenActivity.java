...
public class FacultyAddSchedulerScreenActivity extends Activity {

    Spinner sp_days, sp_semester, sp_subject;
    TimePicker simpleTimePicker;
    Button btn_save;

    String[] days = {"MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY"};
    String[] semester = {"1", "2", "3", "4", "5", "6", "7", "8"};
    String str_days, str_semester, str_subject, str_scheduler_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facultyaddschedulerscreen);
        ...
        simpleTimePicker.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
            ...
            public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
                ...
                str_scheduler_time = hour + ":" + minutes;
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                addSchedulerForFaculty();
            }
        });

    }

    void addSchedulerForFaculty(){
        ...
        params.put("columnnames",
                "facultyid, day, semester, subjectname, times");
        params.put("columnvalues", "'"
                + FacultyMainScreenActivity.str_empid.trim() + "','"
                + str_days.trim() + "','"
                + str_semester.trim() + "','"
                + str_subject.trim() + "','"
                + str_scheduler_time.trim() + "'");
