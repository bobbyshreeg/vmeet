...
public class StudentsProfileScreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.studentsprofilescreen);
    ...
    void getStudentProfileDetails(){
        ...
        params.put("columns", "usn, username, semester, branch, emailid, phoneno");
                    ...
                    public void onSuccess(int statusCode, Header[] header, byte[] byteResponse) {
                        ...
                        try {
                            ...
                            // Else display error message
                                ...
                                et_student_usn.setText(result.getString(0));
                                et_student_name.setText(result.getString(1));
                                et_student_semester.setText(result.getString(2));
                                et_student_branch.setText(result.getString(3));
                                et_student_emailid.setText(result.getString(4));
                                et_student_phoneno.setText(result.getString(5));
                            }
                        } catch (Exception e) {
