...
public class StudentSchedulerlistScreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.studentschedulerlistscreen);
    ...
    void getSchedules(){
        ...
        params.put("tablename", "facultydetails fd, facultyschedulerdetails fsd");
        params.put("columns", "fsd.Id, fd.username, fsd.day, fsd.subjectname, fsd.times");
        params.put("conditions", "fd.empid = fsd.facultyid AND fsd.semester = '" +
                        StudentsMainScreenActivity.str_semester.trim() + "' AND fd.branch = '" +
                StudentsMainScreenActivity.str_branch.trim() + "' order by Id");
                        ...
                        try {
                            ...
                            // Else display error message
                                ...
                                if (empBean.size() > 0) {
                                    ...
                                    adapter = new ListviewAdapterStudentSchedulerList(
                                            act, list);
