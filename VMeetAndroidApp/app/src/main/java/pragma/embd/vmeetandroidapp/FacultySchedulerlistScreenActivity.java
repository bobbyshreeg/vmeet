...
public class FacultySchedulerlistScreenActivity extends Activity {


    Button btn_add_scheduler;
    ListView listView1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facultyschedulerlistscreen);

        btn_add_scheduler = (Button) findViewById(R.id.btn_add_scheduler);
        listView1 = (ListView) findViewById(R.id.listView1);

        act = this;
        getFacultySchedules();

        btn_add_scheduler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                finish();
                Intent schedulerScreen = new Intent(getApplicationContext(), FacultyAddSchedulerScreenActivity.class);
                startActivity(schedulerScreen);
            }
        });
    }

    void getFacultySchedules(){
        ...
        params.put("columns", "Id, day, semester, subjectname, times");
                        ...
                        try {
                            ...
                            // Else display error message
                                ...
                                if (empBean.size() > 0) {
                                    ...
                                    adapter = new ListviewAdapterFacultySchedulerList(
                                            act, list);
