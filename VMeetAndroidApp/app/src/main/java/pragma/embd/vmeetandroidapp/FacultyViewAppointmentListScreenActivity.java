...
public class FacultyViewAppointmentListScreenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facultyviewappointmentlistscreen);
    ...
    void getStudentsAppointmentsList(){
        ...
        params.put("tablename", "studentdetails sd, studentappointmentdetails sad");
        params.put("columns", "sad.Id, sd.username, sd.usn, sad.type1, sad.type2, sad.dates, sad.times");
        params.put("conditions", "sad.studentusn = sd.usn AND sad.status = 'Waiting For Faculty Response' AND sad.facultyid = '" + FacultyMainScreenActivity.str_empid.trim() + "' order by Id");
                        ...
                        try {
                            ...
                            // Else display error message
                                ...
                                if (empBean.size() > 0) {
                                    ...
                                    adapter = new ListviewAdapterFacultyViewAppointmentsList(
                                            act, list);
