    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cgpa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(et_s2.getText().toString().toString().trim().equals("")||
                ...
                if(et_s3.getText().toString().toString().trim().equals("")||
                ...
                if(et_s4.getText().toString().toString().trim().equals("")||
                ...
                if(et_s5.getText().toString().toString().trim().equals("")||
                ...
                if(et_s6.getText().toString().toString().trim().equals("")||
                ...
                if(et_s7.getText().toString().toString().trim().equals("")||
                ...
                if(et_s8.getText().toString().toString().trim().equals("")||
                 ...
                 //   Toast.makeText(getApplicationContext(),"Please Enter Student SGPA for Semester 8", Toast.LENGTH_LONG).show();
                    ...
                    if(et_s2.getText().toString().trim().equalsIgnoreCase("0")){

                        count = count - 1;
                    }
                    if(et_s3.getText().toString().trim().equalsIgnoreCase("0")){

                        count = count - 1;
                    }
                    if(et_s4.getText().toString().trim().equalsIgnoreCase("0")){

                        count = count - 1;
                    }
                    if(et_s5.getText().toString().trim().equalsIgnoreCase("0")){

                        count = count - 1;
                    }
                    if(et_s6.getText().toString().trim().equalsIgnoreCase("0")){

                        count = count - 1;
                    }
                    if(et_s7.getText().toString().trim().equalsIgnoreCase("0")){

                        count = count - 1;
                    }
                    if(et_s8.getText().toString().trim().equalsIgnoreCase("0")){
                    ...
                    str_cgpa = String.valueOf(
                            (Double.valueOf(et_s1.getText().toString().trim()) +
                                    ...
                                    Double.valueOf(et_s8.getText().toString().trim()))/count);
