...
public class ForgotPasswordScreenActivity extends Activity {
  ...
  String str_usertype, str_password, str_phoneno;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        params.put("columns", "Id, pwd, phoneno");
...
public void onSuccess(int statusCode, Header[] header, byte[] byteResponse) {
        ...
        // next screen
                ...
                str_phoneno = result.getString(2);
                sendSMS(str_password, str_phoneno);
                alert_box();
...
public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
    ...
    void sendSMS(String password, String phoneNo){
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                try{
                    ...
                    smsManager.sendTextMessage("+91" + phoneNo.trim(),
                            null, "Your Password is: " + password.trim() , null, null);

                    Toast.makeText(getApplicationContext(),
                            "Password Sent to Your Registered Mobile Number",
                            Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(getApplicationContext(), "in second else",
                    Toast.LENGTH_LONG).show();
